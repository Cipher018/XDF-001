...
| M4x8 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 8 | 0,08 | 0,64 | Local Hardware Store | 0,76 |
| M3x8 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 34 | 0,06 | 2,04 | Local Hardware Store | 2,43 |
| M4x10 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 8 | 0,09 | 0,72 | Local Hardware Store | 0,86 |
| M4x6 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 4 | 0,08 | 0,32 | Local Hardware Store | 0,38 |
| M3x20 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 4 | 0,1 | 0,4 | Local Hardware Store | 0,48 |
| M4x12 Screws | Metric machine screws (M3/M4), zinc plated steel, for mechanical fastening and structural joining | 8 | 0,1 | 0,8 | Local Hardware Store | 0,95 |
| XT60 Male conecctor | LiPo battery input connector, supplies power to the PCB main power rail. | 1 | 0,85 | 0,85 | Local Hardware Store | 1,01 |
| XT60 Female conector | High-current output connector, distributes power from the main rail to loads. | 1 | 0,85 | 0,85 | Local Hardware Store | 1,01 |
| JST Conector | Low-current signal connector for auxiliary peripherals like the FPV camera. | 1 | 0,15 | 0,15 | Local Hardware Store | 0,18 |
| 40 pins socket pack | Interconnection headers for module mounting and replacement on the PCB. | 2 | 0,6 | 1,2 | Local Hardware Store | 1,43 |
| Ceramic capacitor 10nf | High-frequency decoupling on the MPU9250 power supply line. | 1 | 0,08 | 0,08 | Local Hardware Store | 0,1 |
| Ceramic capacitor 100nf | Local decoupling on the power supply lines of all modules. | 7 | 0,07 | 0,49 | Local Hardware Store | 0,58 |
| Electrolitic capacitor 10uf | Mid-frequency filtering on the PCA9685 and NEO-6M logic supply lines. | 2 | 0,12 | 0,24 | Local Hardware Store | 0,29 |
| Electrolitic capacitor 100uf | Voltage stabilization on the ESP32 and NRF24L01 power rails. | 3 | 0,22 | 0,66 | Local Hardware Store | 0,79 |
| Electrolitic capacitor 470uf | Current spike absorption on the PCA9685 servo power rail. | 1 | 0,55 | 0,55 | Local Hardware Store | 0,65 |
